# Contributing to AsBuiltReport.Veeam.VBR
...
1. **Read the documentation** - Check the `README` in the AsBuiltReport.Veeam.VBR repository, including Supported Versions, System Requirements, and Module Installation sections.
...
2. Clone your fork and add the upstream remote:
   ```bash
   git clone https://github.com/<your-username>/AsBuiltReport.Veeam.VBR
   cd AsBuiltReport.Veeam.VBR
   git remote add upstream https://github.com/AsBuiltReport/AsBuiltReport.Veeam.VBR
   ```
...
- Raise an issue in the AsBuiltReport.Veeam.VBR [repository](https://github.com/AsBuiltReport/AsBuiltReport.Veeam.VBR)
