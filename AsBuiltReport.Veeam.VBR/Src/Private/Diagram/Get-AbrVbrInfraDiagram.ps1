    ...
    process {
        if ($VBRServer) {
            ...
            if ($Proxies -and ($ProxiesVi -or $ProxiesHv -or $ProxiesNas)) {
                ...
                SubGraph ProxyServer -Attributes @{Label = (Add-HtmlLabel -Name 'ProxyServer' -ImagesObj $Images -Label 'Backup Proxies' -IconType 'VBR_Proxy' -SubgraphLabel -IconDebug $IconDebug -FontBold); fontsize = 18; penwidth = 1.5; labelloc = 'b'; style = 'dashed,rounded' } {
            ...
            if ($vSphereObj) {
                ...
                foreach ($vCenter in $vSphereObj) {
                    ...
                    try {
                        $ViClustersChildsNodes = foreach ($ViCluster in $vCenter.Childs) {
                            if ($ViCluster.EsxiHost.Name) {
                                ...
                                Add-HtmlTable -Name 'ViClustersChildsNodes' -ImagesObj $Images -Rows 'No Esxi Host' -ALIGN 'Center' -ColumnSize 3 -IconDebug $IconDebug -Subgraph -SubgraphIconType 'VBR_ESXi_Server' -SubgraphLabel $ViCluster.Name -SubgraphLabelPos 'top' -FontColor '#000000' -TableStyle 'dashed,rounded' -TableBorderColor $Edgecolor -TableBorder 1 -FontSize 22 -NoFontBold -SubgraphFontBold -SubgraphTableStyle 'dashed,rounded'
                            }
                        }
                    } catch {
                    ...
                    try {
                        if ($vCenterNodeArray) {
                            $VivCenterNodes += Add-HtmlSubGraph -Name 'VivCenterNodes' -ImagesObj $Images -TableArray $vCenterNodeArray -Align 'Center' -IconDebug $IconDebug -Label 'vCenter Server' -LabelPos 'top' -FontColor $Fontcolor -TableStyle 'dashed,rounded' -TableBorderColor $Edgecolor -TableBorder '1' -ColumnSize 1 -FontSize 22 -FontBold
                        }
                    } catch {
                ...
                foreach ($HyperV in $HyperVObj) {
                    ...
                    try {
                        $HvClustersChildsNodes = & {
                            if ($HyperV.Childs.Name) {
                                Add-HtmlTable -Name 'HvClustersChildsNodes' -ImagesObj $Images -Rows $HyperV.Childs.Name -ALIGN 'Center' -ColumnSize 3 -IconDebug $IconDebug -FontColor '#000000' -TableStyle 'dashed,rounded' -TableBorderColor $Edgecolor -TableBorder 0 -NoFontBold -FontSize 22 -SubgraphFontBold
                            } else {
                                Add-HtmlTable -Name 'HvClustersChildsNodes' -ImagesObj $Images -Rows 'No HyperV Host' -ALIGN 'Center' -ColumnSize $columnSize -IconDebug $IconDebug -FontColor '#000000' -TableStyle 'dashed,rounded' -TableBorderColor $Edgecolor -TableBorder 0 -NoFontBold -FontSize 22 -SubgraphFontBold
                            }
                        }
                    } catch {
                    ...
                    try {
                        if ($HvClustersChildsNodes) {
                            $HvClustersNodes += Add-HtmlSubGraph -Name 'HvClustersNodes' -ImagesObj $Images -TableArray $HvClustersChildsNodes -Align 'Center' -IconDebug $IconDebug -Label 'Hyper-V Servers' -LabelPos 'top' -FontColor $Fontcolor -TableStyle 'dashed,rounded' -TableBorderColor $Edgecolor -TableBorder '1' -ColumnSize 3 -FontSize 22 -FontBold
                    ...
                    try {
                        if ($HyperVNodeArray) {
                            $HvHyperVObjNodes += Add-HtmlSubGraph -Name 'HvHyperVObjNodes' -ImagesObj $Images -TableArray $HyperVNodeArray -Align 'Center' -IconDebug $IconDebug -Label 'Hyper-V Cluster' -LabelPos 'top' -FontColor $Fontcolor -TableStyle 'dashed,rounded' -TableBorderColor $Edgecolor -TableBorder '1' -ColumnSize 1 -FontSize 22 -FontBold
                        }
                    } catch {
                    ...
                    try {
                        $CGPoolNode = foreach ($CGPool in $CGPoolInfo) {
                            if ($CGPoolInfo.CloudGateways) {
                                ...
                                Add-HtmlTable -Name 'CGPoolNode' -ImagesObj $Images -Rows $CGPool.CloudGateways.Name.split('.')[0] -ALIGN 'Center' -ColumnSize $columnSize -IconDebug $IconDebug -Subgraph -SubgraphIconType 'VBR_Cloud_Connect_Gateway' -SubgraphLabel $CGPool.Name -SubgraphLabelPos 'top' -FontColor '#000000' -TableStyle 'dashed,rounded' -TableBorderColor $Edgecolor -TableBorder 0 -NoFontBold -FontSize 18 -SubgraphFontBold
                            } else {
                                Add-HtmlTable -Name 'CGPoolNode' -ImagesObj $Images -Rows 'No Cloud Gateway Server' -ALIGN 'Center' -ColumnSize 1 -IconDebug $IconDebug -Subgraph -SubgraphIconType 'VBR_Cloud_Connect_Gateway' -SubgraphLabel $CGPool.Name -SubgraphLabelPos 'top' -FontColor '#000000' -TableStyle 'dashed,rounded' -TableBorderColor $Edgecolor -TableBorder 0 -NoFontBold -FontSize 18 -SubgraphFontBold
                            }
                        }
                    } catch {
