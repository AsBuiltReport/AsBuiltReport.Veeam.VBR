                        ...
                        if ($CloudObject.ResourcesEnabled) {
                            $CloudObject.Resources | ForEach-Object {
                                ...
                                [PSCustomObject]@{
                                    ...
                                    Label = Add-NodeIcon -Name "$($_.RepositoryFriendlyName)" -IconType 'VBR_Cloud_Repository' -Align 'Center' -AditionalInfo $AditionalInfo -ImagesObj $Images -IconDebug $IconDebug -FontSize 18 -FontBold -TableBackgroundColor $MainGraphBGColor -CellBackgroundColor $MainGraphBGColor -FontColor $Fontcolor
                                    Id = $_.Id
                                    ...
                                    SubTenant = & {
                                        ...
                                        Get-CloudSubTenant -Tenant $CloudObject | Where-Object { $_.Resources.ParentId.Guid -eq $Guid } | ForEach-Object {
                                            ...
                                            [PSCustomObject]@{
                                                Name = $_.Name
                                                Label = Add-NodeIcon -Name "$($_.Name)" -IconType 'VBR_Cloud_Sub_Tenant' -Align 'Center' -ImagesObj $Images -IconDebug $IconDebug -FontSize 18 -AditionalInfo $AditionalInfo -FontBold -TableBackgroundColor $MainGraphBGColor -CellBackgroundColor $MainGraphBGColor -FontColor $Fontcolor
                                                Id = $_.Id
                                                    ...
                                                    NetworkExtensions = & {
                                                        if ($NetExEnabled) {
                                                            Get-AbrCloudTenantNetworkAppliance -Tenant $CloudObject | Where-Object { $_.HardwarePlanId -eq $HardwarePlanId } | ForEach-Object {
                                                                ...
                                                                [PSCustomObject]@{
                                                                    Name = $_.Name
                                                                    Label = Add-NodeIcon -Name "$($_.Name)" -IconType 'VBR_Cloud_Network_Extension' -Align 'Center' -ImagesObj $Images -IconDebug $IconDebug -AditionalInfo $AditionalInfo -FontSize 18 -FontBold -TableBackgroundColor $MainGraphBGColor -CellBackgroundColor $MainGraphBGColor -FontColor $Fontcolor
                                                                    AditionalInfo = $AditionalInfo
