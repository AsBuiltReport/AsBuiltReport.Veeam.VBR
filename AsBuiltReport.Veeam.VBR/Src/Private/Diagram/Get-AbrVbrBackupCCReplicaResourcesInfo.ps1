function Get-AbrBackupCCReplicaResourcesInfo {
    <#
    .SYNOPSIS
            ...
            if ($CloudObjects = Get-VBRCloudHardwarePlan | Sort-Object -Property Name) {
                foreach ($CloudObject in $CloudObjects) {
                    ...
                    $TempBackupCCReplicaResourcesInfo = [PSCustomObject]@{
                        ...
                        Label = Add-NodeIcon -Name "$((Remove-SpecialCharacter -String $CloudObject.Name.split('.')[0] -SpecialChars '\').toUpper())" -IconType 'VBR_Hardware_Resources' -Align 'Center' -AditionalInfo $AditionalInfo -ImagesObj $Images -IconDebug $IconDebug -FontSize 18 -FontBold -TableBackgroundColor $MainGraphBGColor -CellBackgroundColor $MainGraphBGColor -FontColor $Fontcolor
                        Id = $CloudObject.Id
                        ...
                        Host = & {
                            ...
                            [pscustomobject]@{
                                ...
                                IconType = $IconType
                                AditionalInfo = $AditionalInfo
                                Label = Add-NodeIcon -Name "$((Remove-SpecialCharacter -String $CloudObject.Host.Name.split('.')[0] -SpecialChars '\').toUpper())" -IconType 'VBR_Hardware_Resources' -Align 'Center' -AditionalInfo $AditionalInfo -ImagesObj $Images -IconDebug $IconDebug -FontSize 18 -FontBold -TableBackgroundColor $MainGraphBGColor -CellBackgroundColor $MainGraphBGColor -FontColor $Fontcolor
                            }
                        }
                        Storage = & {
                            $CloudObject.Datastore | ForEach-Object {
                                ...
                                [PSCustomObject]@{
                                    ...
                                    AditionalInfo = $AditionalInfo
                                    Label = Add-NodeIcon -Name $_.FriendlyName -IconType 'VBR_Cloud_Storage' -Align 'Center' -AditionalInfo $AditionalInfo -ImagesObj $Images -IconDebug $IconDebug -FontSize 18 -FontBold -TableBackgroundColor $MainGraphBGColor -CellBackgroundColor $MainGraphBGColor -FontColor $Fontcolor
