...
$Cred = New-Object System.Management.Automation.PSCredential ("pharmax.local\administrator", $password)
...
Connect-VBRServer -Server VEEAM-VBR-CC-01.acad.pharmax.local -Credential $cred

Import-Module AsBuiltReport.Veeam.VBR -Force

New-AsBuiltReport -Report Veeam.VBR -Target VEEAM-VBR-CC-01.acad.pharmax.local -AsBuiltConfigFilePath C:\Users\jocolon\AsBuiltReport\AsBuiltReport.json -OutputFolderPath C:\Users\jocolon\AsBuiltReport\ -Credential $cred -Format HTML -ReportConfigFilePath C:\Users\jocolon\AsBuiltReport\AsBuiltReport.Veeam.VBR.json -EnableHealthCheck
...
Connect-VBRServer -Server VEEAM-VBR-12V.pharmax.local -Credential $cred

Import-Module AsBuiltReport.Veeam.VBR -Force

New-AsBuiltReport -Report Veeam.VBR -Target VEEAM-VBR-12V.pharmax.local -AsBuiltConfigFilePath $env:USERPROFILE\AsBuiltReport\AsBuiltReport.json -OutputFolderPath $env:USERPROFILE\AsBuiltReport\ -Credential $cred -Format HTML -ReportConfigFilePath $env:USERPROFILE\AsBuiltReport\AsBuiltReport.Veeam.VBR.json -EnableHealthCheck
